...
namespace Rummy
{
    ...
    public class ProtectedData
    {
        ...
        [SerializeField]
        List<byte> releasedDeckCards = new List<byte>();
        [SerializeField]
        ...
        {
            return releasedDeckCards;
        }

        public void SetReleasedDeck(List<byte> cardValue)
        {
            releasedDeckCards = cardValue;
        }
        ...
        public void AddCardValueToReleaseDeck(byte cardValue)
        {
            releasedDeckCards.Add(cardValue);
        }

        public void RemoveCardValueToReleaseDeck(byte cardValue)
        {
            releasedDeckCards.Remove(cardValue);
        }
