...
namespace Rummy
{
    ...
    public class Card : MonoBehaviour
    {
        ...
        {
            //Debug.Log("rank" + (value % 13 + 1));
            return (Ranks)(value % 13 + 1);
           // return (value % 13 + 1);
        ...
        {
            //Debug.Log("suit" + Mathf.Ceil(value / 13));
            return (Suits)Mathf.Ceil(value / 13);
        ...
        public CardValue cardValue = CardValue.NoValue;
        ...
        public void SetCardValue(byte value)
        {
            ...
            // ...
            // 48-51 are kings's
            Rank = (Ranks)(value % 13 + 1);

            // 0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48 are Spades(0)
            Suit = (Suits)Mathf.Ceil(value / 13);
        ...
        string SpriteName()
        {
           // Debug.Log("value"+cardValue);
            //string testName = $"card{Suit}{GetRankDescription()}";
            string testName = $"card" +cardValue;
            return testName;
        }
